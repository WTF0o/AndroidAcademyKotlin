...
object KotlinWorkshop1 {
    ...
    fun main(args: Array<String>) {
        ...
        val sum : Int? = firstNumber?.plus(secondNumber ?: firstNumber!!) ?: null
       ...
       print("Пожалуйста введите первое число: ")
        val firstIntInput: Int? = MyScanner.scan.nextInt() ?: 10 // <--- вводим первое число
        print("Пожалуйста введите второе число: ")
        val secondIntInput: Int? = MyScanner.scan.nextInt() ?: 5// <--- вводим второе число
